...
const pageJsonLd = {
  ...
  description:
    "Examples of Artecho AI restoration previews for common painting damage types.",
...
const cases = [
  {
    ...
    bullets: [
      ...
      "Artecho AI matched surrounding stroke direction and paint thickness in preview",
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    bullets: [
      ...
      "Artecho AI inferred facial structure from intact sections for preview",
    ],
  },
];
    ...
    <>
      ...
      <Section>
        ...
        <p className="text-lg text-text-secondary leading-relaxed max-w-2xl">
          Examples show how Artecho AI handles common damage types. These are
          previews for planning and documentation, not final restoration
          outcomes.
        </p>
      </Section>
      ...
      <Section tight>
        <Callout variant="trust">
          These are AI-generated previews for planning and documentation
          purposes only. They show potential restoration outcomes — not final or
          recommended treatments. All restoration decisions require qualified
          conservators.
        </Callout>
      </Section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {(["before", "mask", "preview"] as const).map((type) => (
                    <figure key={type}>
                      ...
                      <figcaption className="mt-2 text-xs text-muted capitalize text-center">
                        {type}
                      </figcaption>
                    </figure>
                  ))}
      ...
      <Section surface divider>
        <div className="text-center max-w-lg mx-auto">
          ...
          <p className="text-text-secondary mb-7">
            ...
            images and see previews for your collection.
          </p>
